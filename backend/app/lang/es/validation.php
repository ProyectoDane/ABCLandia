...
return array(
    ...
    */
    ...
    "format"               => "El formato de :attribute es inválido.",
    "letra"                => "El campo :attribute debe empezar con la letra seleccionada.",
    "completa"             => "La categoría no está completa",
    "unique_with"          => "La combinación de los campos nombre y apellido ya ha sido tomada",
    "fecha"                => "El campo :attribute no es una fecha válida",
